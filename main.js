...
app.on('ready', function() {
  ...
  ipcMain.on('startup-enable', () => !isLinux && autoStart.enable());
  ipcMain.on('startup-disable', () => !isLinux && autoStart.disable());
  ipcMain.on('check-update', () => !isLinux && checkAutoUpdate(true));
