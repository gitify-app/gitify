  ...
  render() {
    ...
    return (
      <div className="container-fluid main-container login">
        ...
        >
          <FontAwesomeIcon className="mr-2" icon={faGithub} title="GitHub" /> Login to GitHub
        </button>

        <Link to="/enterpriselogin" className="btn btn-block btn-login mt-3">
          <FontAwesomeIcon className="mr-2" icon={faGithub} title="GitHub" /> Login to GitHub Enterprise
        </Link>
      </div>
    );
  }
